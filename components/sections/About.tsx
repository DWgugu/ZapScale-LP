            ...
            <div className="mx-auto">
                ...
                <div className="relative -mb-[120px] md:-mb-[150px] max-w-4xl mx-auto px-6 z-30">
                    <div className="rounded-2xl overflow-hidden shadow-xl bg-gradient-to-r from-purple-600 via-blue-600 to-green-500 p-1">
                        <div className="p-4 sm:p-1 bg-white rounded-2xl h-[300px] flex flex-col items-center justify-center text-white text-lg gap-8">
                            <h3 className="sm:text-[28px] text-[20px] font-semibold leading-tight text-[#1a1a1a] text-center mt-4">
                                Experimente gratuitamente
                            </h3>
                            <p className="sm:text-base text-sm text-[#1a1a1a] leading-relaxed text-center">
